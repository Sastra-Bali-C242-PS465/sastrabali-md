...
class HomeDictionaryAdapter(
    private val dictionaries: List<DictionaryItem>,
    private val onItemClick: (DictionaryItem) -> Unit
) : RecyclerView.Adapter<HomeDictionaryAdapter.DictionaryViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DictionaryViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.card_dictionary_home, parent, false)
